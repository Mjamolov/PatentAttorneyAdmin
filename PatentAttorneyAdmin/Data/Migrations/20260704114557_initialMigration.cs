        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassportFrontPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PassportBackPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TitleTj = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DescriptionRu = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DescriptionTj = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientRequests_ServiceCategories_ServiceCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RequestMessages_AspNetUsers_SenderUserId",
                        column: x => x.SenderUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RequestMessages_ClientRequests_ClientRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientRequests_ServiceCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestMessages_ClientRequestId",
                table: "RequestMessages",
                column: "ClientRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_RequestMessages_SenderUserId",
                table: "RequestMessages",
                column: "SenderUserId");
        }
